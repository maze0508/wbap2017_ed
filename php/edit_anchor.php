...
$script=mysql_escape_string($_POST['script']);
...
$query="UPDATE img_anchor SET image='$image',script='$script',start_time='$start_time',stop_time='$stop_time' WHERE img_anchor_id='$img_anchor_id'";
