...
<div id="page" style=" height:500px; background-repeat:no-repeat;
	...
	background-size:40%;background-image: url(images/test/adm-addtr2.png);">
	<!-- start content -->
	<div id="content" style="">
	<div class="Tit"><img src="images/test/pic-Tit.png"/>教師匯入/新增</div><br/><br/>
		<div class="post">
			<h2 class="title"><a href="#">教師檔案上傳</a></h2>
			<div class="entry">
				<a href="excel_tea.xls">*excel檔案格式_範例下載</a>
	...
	<!-- start sidebar -->
	<div id="sidebar">
	<h2 class="title"><a href="#">建立教師檔案</a></h2>
                ...
                <label>服務單位：</label><input type="text" name="unit" class="required" minlength="3" /><p>
                <label>電子郵件：</label><input type="text" name="email" class="required email"  /><p>
				<input type="hidden" name="addcompet" value="2"  />
...
$("#uploadify").uploadify({
		...
		'scriptData'	 : {'addcompet':'2'},    /*這行是可以帶value到後端，但會有亂碼，所以前面才要base64編碼*/
		'auto'           : false,
		'multi'          : true,
		'queueSizeLimit' :'5',
